...
def assert_onset_within_tolerance(detected_ms: float | None, truth_ms: float, tolerance_ms: float, scenario: str):
...
def test_01_exact_match(tmp_path, patch_separator, mdx_config_tight, model_placeholder):
    """
    ...
    audio_result = build_stereo_test(
        ...
        duration_ms=30000,
        vocal_events=[VocalEvent(onset_ms=onset_ms, duration_ms=10000, fade_in_ms=50, amp=0.7)],
...
def test_02_close_match(tmp_path, patch_separator, mdx_config_tight, model_placeholder):
    """
...
def test_03_reasonable_offset(tmp_path, patch_separator, mdx_config_tight, model_placeholder):
    """
...
def test_04_large_offset_expansion(tmp_path, patch_separator, mdx_config_tight, model_placeholder):
    """
    ...
    audio_result = build_stereo_test(
        ...
        duration_ms=60000,
        vocal_events=[VocalEvent(onset_ms=onset_ms, duration_ms=15000, fade_in_ms=100, amp=0.7)],
        instrument_bed=InstrumentBed(noise_floor_db=-60.0),
    )
...
def test_05_early_stop_when_close(tmp_path, patch_separator, mdx_config_tight, model_placeholder):
    """

...
class TestDetectWorkflowFromGUI:
    ...
    def test_detect_button_click_triggers_actions_detect_gap(
    ...
    def test_detect_workflow_not_triggered_without_audio(
    ...
    def test_detect_workflow_enabled_for_mixed_selection(
    ...
    def test_detect_workflow_with_single_song(
        self, menu_bar, mock_actions, songs_with_audio
    ):
    ...
    def test_detect_workflow_with_no_selection(
...
class TestDetectButtonStateTransitions:
    ...
    def test_detect_button_enables_when_valid_selection_set(
    ...
    def test_detect_button_disables_when_selection_cleared(
        self, menu_bar, songs_with_audio
    ):
    ...
    def test_detect_button_state_updated_on_each_selection_change(

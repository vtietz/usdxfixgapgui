...
from utils.files import is_portable_mode, get_localappdata_dir
...
class TestDataDirectorySelection:
    ...
    def test_portable_mode_uses_app_dir(self):
        ...
        with (
            patch("utils.files.is_portable_mode", return_value=True),
    ...
    def test_windows_non_portable_uses_localappdata(self):
        ...
        with (
            patch("utils.files.is_portable_mode", return_value=False),

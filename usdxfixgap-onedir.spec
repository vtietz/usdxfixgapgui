...
"""
PyInstaller spec file for USDXFixGap (ONEDIR build)
Builds a directory-based executable for fast CI/CD validation.
This build is used internally for testing - NOT for user releases.
"""
import sys

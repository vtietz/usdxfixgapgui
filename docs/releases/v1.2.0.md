...
### Developer & Quality
- New: 617 cross-platform tests with automated CI/CD
- Chore: Fixed 56 type errors for better IDE support and type safety
- Chore: GitHub Actions automated builds for Windows/Linux/macOS
- Chore: GPU Pack runtime hook refactored for reliable PyInstaller builds
...
- Fix: MDX gap detection for late expected gaps (distance-based band gating replaces absolute-time gating)
- Fix: UI freezes during gap detection (media player unload before processing)
- Fix: GPU Pack compatibility and error handling

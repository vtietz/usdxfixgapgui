...
class Actions(QObject):
    ...
    def __init__(self, data: AppData):
        ...
        # Don't use QTimer in constructor - we'll call auto_load directly
        # from main.py after the application is fully initialized
    ...
    # Fix typo in method name for clarity
